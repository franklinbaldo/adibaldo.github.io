  ...
  const frontMatter = [
    // PREFÁCIO: INTRÓITO OU PROLEGÔMENOS + PUBLICO OU NÃO PUBLICO
    `<div class="chapter front-matter">

# Prefácio

## Intróito ou Prolegômenos
...
Sobre tudo isso digo alguma coisa. Não se trata de uma biografia, mas de temas esparsos que acabam por revelar momentos do passado. De início denominei esta obra de *Passa Tempo*, mas depois percebendo que se trata de uma mistureba, denominei **EITA LASQUEIRA**.
...
Caso o amigo e bom camarada leitor tenha lido esta parte, recomendo ler tudo o que mais consta dos autos e assim poder fazer um arrazoado e tecer comentários e dar aquele LIKE que nos enche de satisfação.
...
Dedico a quem escreveu, portanto mim mesmo. Outra pessoa não merece tamanha desfaçatez. Não que a presente seja um impropério, porém ninguém mais que eu dispensaria horas e horas rabiscando, apagando e rescrevendo até que ficasse do meu gosto. Outros poderão gostar, coisa que duvido.

Prefiro não correr o risco de dedicar o presente cartapácio a alguém e depois saber que sequer leu. Já não se faz mais leitores como antigamente. Leitor voraz daqueles que começavam logo após o jantar e só largavam na madrugada. Também pudera, as mensagens de WhatsApp ou de outras mídias são muito mais interessantes. *"Oi amigo, não visualizei porque estava lendo um livro... kkk"*. É ruim!? Só por isso não me atrevo fazer uma dedicação.
...
*Nasci tosco, assim desse jeito.*
*Humano, com muitos defeitos.*
*Cresci, perambulei, fiz andanças,*
*Tive peleias, por vezes nada mansas.*
*Seguindo o rito, dei o primeiro passo.*
*Maço, cinzel, esquadro e compasso.*
*Olhos vendados e peito descoberto,*
*Fui conduzido pelo primeiro esperto*
*No silêncio da câmara de reflexão;*
*O derradeiro testamento foi feito.*
*Ainda vedado, ocorreu a iniciação.*
*Após jurar, dobrando o joelho direito*
*Foi me dada a luz e conheci os irmãos.*
*Fiquei em pé à ordem. Assim, desse jeito!*
...
Já é público e notório que quem conta um conto, aumenta um ponto, sempre puxando o braseiro para o seu assado. Aqui sirvo cru, ou simplesmente sapecado. Não é restaurante gourmet onde a comida é feita de forma criteriosa, com produtos de qualidade, perfeitamente preparada e artisticamente apresentada.
...
A **FINALIDADE** é sorver o tempo. Lentamente, percebendo os seus sabores e cheiros. Fazer da vida o *"dolce far niente"*.

Sempre tive o desejo de escrever um opúsculo qualquer, contudo, só o desejo não basta. Tem que haver uma finalidade ou uma necessidade. Quanto a isto, questiono: — Necessário pra quem? — Afinal existem milhares de livros, jamais lidos e outros tantos escondidos.
...
De Sócrates, falou Platão; e de Jesus, nem Deus sabe, porque dele só têm os disque-disque dos evangelhos. Não há, no entanto, como negar que tenham mudado o pensamento da humanidade.

Por certo a finalidade não é mudar a humanidade. Pretendo apenas usufruir o tempo. Esse dilema me remete ao mestre de direito, Haroldo Valadão, que do alto de seus oitenta anos, na VII Conferência da Ordem dos Advogados do Brasil, em 1978 na UFPR, aconselhou os jovens gazeteiros que perambulavam pelos corredores: *"Não percam tempo fazendo hoje aquilo que pode ser feito amanhã, porque amanhã poderá não ser necessário."* — Assim, faço apenas pela minha necessidade.

No futuro poderá haver alguém com necessidade de ler. Que leiam. Leia quem quiser e se puder compartilhe, deixe seu "like". O "pancrácio Xandão" arrumou muitos inimigos por conta dessa tese atabalhoada. Também não escrevo sob pressão de uma Delação Premiada. Resto-me, no entanto, a vã expectativa de ser anistiado pelos meus crimes não cometidos. De qualquer forma, *data vênia*, me declaro inocente perante ao impoluto Poder Julgador.

Caso não gostem, paciência. Nesse caso, vão plantar batatas, visto que foram elas que efetivamente já salvaram a humanidade. Recomendo que plantem mandioca, aipim, macaxeira, maniva — a legítima cultura tupiniquim.

*Machado de Assis disse: "Ao vencedor as batatas." Tivesse se ocupado da cultura tupiniquim ao invés do humanismo, teria dito: "Ao vencedor a mandioca."*

Veja a finalidade de Deus ao sentenciar: — *"Haja luminares no firmamento do céu para separar o dia da noite."* (Gênesis 1:14-15). Tudo isso para iluminar um grão de areia. Mas quem sabe dos desígnios de Deus?

Disse o Criador: *"Façamos o homem a nossa imagem e semelhança."* Um *"momentito, un momentito"* — quer dizer que ele não estava sozinho? Seja como for, não explicitou com que finalidade criou o homem. Bem que podia ter terceirizado a culpa, já que não fez sozinho.

De qualquer forma sou grato a Ele.
...
*Agradeço primeiro a quem*
*Orientou os meus passos,*
*Abrandou minhas dores,*
*Estimulou os meus atos*
*E no chão semeou flores.*
*Agradeço a quem me deu carinho,*
*Razão para lutar e viver.*
*A quem iluminou meu caminho*
*Dando-me esperança e saber.*
*Aos pais, irmãos, esposa e filhos;*
*Aos amigos que já não lembro.*
*A todos que me prestaram auxílio —*
*Mestres, vizinhos e parceiros;*
*Extensão dos meus braços.*
*Todos, do último ao primeiro.*
...
Encarar os fatos. A vida é viver. Trajetórias de altos e baixos, onde os desejos e as paixões se entrelaçam. Este foi um momento baixo, um momento confuso e tenso, mas, só um momento. Não seria eu o primeiro nem o último. — Se é pra ser, assim será. Buscados os caminhos, correndo e batendo cabeça, em 30 dias a válvula mitral foi substituída.
...
Todavia, o carinho e atenção das pessoas fazem a diferença. O coquetel de comprimidos com certeza estabiliza e tonifica, no entanto, o ingrediente da vida vem do amor dos familiares — esposa, filhos, noras, genro, irmãos, cunhadas, sobrinhos, netos — e do apoio dos amigos e dedicação dos profissionais.
...
Sou muito grato ao cirurgião **Dr. José Augusto Moutinho**, de Curitiba, pelo seu profissionalismo, competência e simplicidade, o qual me encaminhou ao Hospital Angelina Caron onde realizou a cirurgia.

Passado algum tempo, a recomendação foi a instalação de um Marcapasso CDI tricúspide. Após todos os atropelos, o problema foi resolvido no Hospital Público em Porto Velho, com o **Dr. Marcos Rosa** — profissional altamente qualificado.

Ao todo 72 dias internado. Estar internado por tanto tempo é desgastante, em que pese o profissionalismo e atenção da equipe técnica — médicos, enfermeiras, auxiliares de enfermagem e zeladoras.

Tudo foi menos traumático graças ao acompanhamento constante da minha esposa **Valdete**. O hospital exige acompanhamento, porém não oferece qualquer conforto ao acompanhante. Foi necessário improvisar — um colchão estendido no chão, camuflado durante o dia. Essa parte pode-se dizer que é desumano. Ali fiz amizade com muitos. Uns partiram para o Oriente Eterno e outros retornaram felizes para seus lares.

Tudo melhorou, porém máquina é máquina e nada substitui o órgão natural. Periodicamente as revisões devem ser feitas. A vida passa a ser limitada. Ora uma tontura seguida de cansaço, ora sentindo o marcapasso fazer o seu trabalho.

O progresso tecnológico faz parte do plano de Deus.

*"Honra ao médico, porque ele é necessário, pois foi o Altíssimo que o criou."* (Eclesiástico 38:1)
